...
detector: MtcnnDetector = MtcnnDetector(model_folder='/app/app/modules/mtcnn_model', ctx=mx.cpu(), num_worker=1,
...
async def detect_image(request: aiohttp.web.Request):
    ...
    for i in detection_result[0]:
        ...
        cv.putText(im, text, (bbox[0], bbox[1] - 10), cv.FONT_HERSHEY_SIMPLEX, 0.9, color, 2)
